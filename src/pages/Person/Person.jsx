...
async function updateProfile() {
  ...
  useEffect(() => {
    fetchData()
    if (cardChecked !== personProfile.card || presentChecked !== personProfile.present) {
      updateProfile();
    }
        ...
        <div className="card-body">
          ...
          <div className="mb-3">
            <label className="swap swap-flip mr-1">
              ...
              <input type="checkbox" checked={cardChecked} onChange={() => setCardChecked(prevState => !prevState)} />Card?
            ...
            <label className="swap swap-flip ml-1">
              {/* Hidden checkbox to control the state */}
              <input type="checkbox" checked={presentChecked} onChange={() => setPresentChecked(prevState => !prevState)} />Present?
